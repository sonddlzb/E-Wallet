...
extension UIImage {
    static let ic_bookmark_selected = UIImage(named: "ic_bookmark_selected")
    static let ic_bookmark_black = UIImage(named: "ic_bookmark_black")
    static let ic_bookmark = UIImage(named: "ic_bookmark")
}
